...
export function LangProvider({ children }: { children: React.ReactNode }) {
  ...
  'common.all_domains': 'All Domains',
  ...
  'common.color': 'Color',
  'common.code': 'Code',
  'common.name_ar': 'Arabic Name',
  'common.all_stakeholders': 'All Stakeholders',
  'common.all_categories': 'All Categories',
  'common.all_status': 'All Status',
  'common.draft': 'Draft',
  'common.published': 'Published',
  'common.all_states': 'All Architecture States',
  ...
  'common.meta_attrs': 'META MODEL ATTRIBUTES',
  'common.no_attachments': 'No attachments yet',
  'common.severity': 'Severity',
  'common.recommendation': 'Recommendation',
  'common.solution': 'SOLUTION',
  'common.business_owner': 'BUSINESS OWNER',
  'common.tech_owner': 'TECH OWNER',
  'common.tech_detected': 'TECHNOLOGIES DETECTED',
  'common.open': 'Open',
  'common.accepted': 'Accepted',
  'common.confirmed': 'Confirmed',
  'common.rejected': 'Rejected',
  'common.all_review_types': 'All Review Types',
  'common.quick_actions': 'QUICK ACTIONS',
  'app.title': 'EA Platform',
  'framework.nora': 'NORA',
  'shared.link_unavailable': 'Link unavailable',
  'shared.title': 'Shared View',
  'glossary.subtitle': 'Bilingual EA terminology definitions for this tenant',
  'glossary.new_term': '+ New Term',
  'glossary.title': 'EA Glossary',
  'eaplanning.subtitle': 'Strategic and operational plans for the EA practice',
  'eaplanning.total_plans': 'Total Plans',
  'eaplanning.avg_progress': 'Avg Progress',
  'eaplanning.high_risk': 'High-Risk Plans',
  'eaplanning.by_type': 'By Plan Type',
  'eaplanning.new_plan': 'New EA Plan',
  'eaplanning.plan_type': 'Plan Type *',
  'eaplanning.period_label': 'Period Label',
  'eaplanning.domains_scope': 'EA Domains in Scope',
  'eaplanning.title': 'EA Planning',
  'accessgov.tenant_roles': 'Tenant Roles',
  'accessgov.pending_requests': 'Pending Access Requests',
  'accessgov.sod_conflicts': 'SoD Conflicts',
  'accessgov.system_template': 'System Template',
  'accessgov.privileged': 'Privileged',
  'accessgov.title': 'Access Governance',
  'connector.active': 'Active Connectors',
  'connector.none': 'No connectors configured',
  'connector.file_based': 'File-based',
  'connector.api_sync': 'API Sync',
  'connector.name': 'Connector Name *',
  'connector.direction': 'Sync Direction',
  'connector.base_url': 'API Base URL',
  'connector.auto_sync': 'Enable automatic sync',
  'connector.auth_type': 'Auth Type',
  'connector.title': 'Connector Hub',
  'metamodel.name': 'Meta-Model Name *',
  'metamodel.domains': 'Domains',
  'metamodel.domains_desc': 'Organize your meta-model by architectural domains',
  'metamodel.object_types': 'Object Types',
  'metamodel.object_types_desc': 'EA entity types defined in your meta-model',
  'metamodel.title': 'Meta-Model',
  'eaviews.library': 'View Library',
  'eaviews.my_views': 'My Views',
  'eaviews.rel_changes': 'Relationship Changes',
  'eaviews.title': 'EA Views',
  'copilot.new_meeting': 'New Meeting',
  'copilot.meeting_title': 'Meeting Title *',
  'copilot.meeting_date': 'Meeting Date',
  'copilot.meeting_desc': 'Upload meeting transcripts and get domain-specific architect',
  'copilot.no_meetings': 'No meetings yet',
  'copilot.new_conversation': '+ New Conversation',
  'copilot.no_conversations': 'No conversations yet',
  'copilot.multi_architect': 'Multi-Architect Consultation',
  'copilot.cache_hint': 'Context cached 5 min',
  'adm.use': '+ Use',
  'adm.ai_ready': 'AI CONTENT READY',
  'adm.steps': 'STEPS',
  'adm.no_inputs': 'No inputs for this step',
  'adm.no_outputs': 'No outputs for this step',
  'adm.export': 'Export ADM Cycle Package',
  'settings.appearance_desc': 'Customize the platform appearance for your organization',
  'settings.logo': 'Logo',
  'settings.no_logo': 'No logo uploaded',
  'settings.favicon': 'Favicon',
  'settings.no_favicon': 'No favicon uploaded',
  'settings.export_desc': 'Configure default behavior for Word and PowerPoint exports',
  'settings.export_lang': 'Default Export Language',
  'settings.template_style': 'Template Style',
  'settings.style_professional': 'Professional',
  'settings.style_government': 'Government',
  'settings.style_minimal': 'Minimal',
  'settings.footer_text': 'Footer Text',
  'settings.gov_desc': 'Configure architecture governance workflows and approval thresholds',
  'settings.gov_mode': 'Governance Mode',
  'governance.no_findings': 'No findings match the active severity filter',
  'governance.title': 'Governance Reviews',
  'severity.critical': 'CRITICAL',
  'severity.high': 'HIGH',
  'severity.medium': 'MEDIUM',
  'severity.low': 'LOW',
  'strategy.current_alignments': 'Current Alignments',
  'strategy.overall_score': 'Overall Score',
  'strategy.strong_goals': 'Strong Goals',
  'strategy.goals_with_gaps': 'Goals with Gaps',
  'review.hld': 'HLD Review',
  'review.lld': 'LLD Review',
  'domain.app_integration': 'Application Integration',
  'domain.data': 'Data Architecture',
  'domain.infrastructure': 'Infrastructure',
  'domain.security': 'Security Architecture',
  'domain.business': 'Business Architecture',
  'domain.beneficiary': 'Beneficiary Experience',
  'dashboard.monthly_reviews': 'Monthly Reviews & Avg Score',

  'common.more_info': 'More information',
  'diagramviewer.diagrams': 'Diagrams ({count})',
  'diagramviewer.view': '▼ View',
  'diagramviewer.hide': '▲ Hide',
  'diagramviewer.source': '< Source',
  'diagramviewer.visual': '👁 Visual',
  'diagramviewer.download_svg': '↓ SVG',
  'diagramviewer.download_source': '↓ Source',
  'phase7.phase_step': 'Phase {phase}{step}',
  'phase7.domains': 'Domains: {domains}',
  'phase7.ref': 'Ref: {ref}',
  'phase7.rationale': 'Rationale:',
  'phase7.notes': 'Notes:',
  'innovation.change_reason': '{reason}',
  ...
  'common.definition': 'التعريف',
  'common.all_domains': 'جميع المجالات',
  'common.active': 'نشط',
  ...
  'common.color': 'اللون',
  'common.code': 'الرمز',
  'common.name_ar': 'الاسم بالعربية',
  'common.all_stakeholders': 'جميع أصحاب المصلحة',
  'common.all_categories': 'جميع الفئات',
  'common.all_status': 'جميع الحالات',
  'common.draft': 'مسودة',
  'common.published': 'منشور',
  'common.all_states': 'جميع حالات المعمارية',
  'common.promise': 'وعد',
  'common.left': 'يسار',
  'common.right': 'يمين',
  'common.added': 'مضاف',
  'common.modified': 'معدل',
  'common.unchanged': 'دون تغيير',
  'common.auto_detect': 'اكتشاف تلقائي',
  'common.approve': 'موافقة',
  'common.total': 'الإجمالي',
  'common.asset_type': 'نوع الأصل',
  'common.owner': 'المالك',
  'common.version': 'الإصدار',
  'common.meta_attrs': 'سمات النموذج الوصفي',
  'common.no_attachments': 'لا توجد مرفقات بعد',
  'common.severity': 'الخطورة',
  'common.recommendation': 'التوصية',
  'common.solution': 'الحل',
  'common.business_owner': 'مالك العمل',
  'common.tech_owner': 'مالك التقنية',
  'common.tech_detected': 'التقنيات المكتشفة',
  'common.open': 'مفتوح',
  'common.accepted': 'مقبول',
  'common.confirmed': 'مؤكد',
  'common.rejected': 'مرفوض',
  'common.all_review_types': 'جميع أنواع المراجعة',
  'common.quick_actions': 'إجراءات سريعة',
  'app.title': 'منصة هندسة المؤسسات',
  'framework.nora': 'نورا',
  'shared.link_unavailable': 'الرابط غير متاح',
  'shared.title': 'عرض مشترك',
  'glossary.subtitle': 'تعريفات المصطلحات ثنائية اللغة لهندسة المؤسسات',
  'glossary.new_term': '+ مصطلح جديد',
  'glossary.title': 'مسرد المصطلحات',
  'eaplanning.subtitle': 'خطط استراتيجية وتشغيلية لممارسة هندسة المؤسسات',
  'eaplanning.total_plans': 'إجمالي الخطط',
  'eaplanning.avg_progress': 'متوسط التقدم',
  'eaplanning.high_risk': 'خطط عالية المخاطر',
  'eaplanning.by_type': 'حسب النوع',
  'eaplanning.new_plan': 'خطة هندسة معمارية جديدة',
  'eaplanning.plan_type': 'نوع الخطة *',
  'eaplanning.period_label': 'تسمية الفترة',
  'eaplanning.domains_scope': 'مجالات هندسة المؤسسات في النطاق',
  'eaplanning.title': 'تخطيط هندسة المؤسسات',
  'accessgov.tenant_roles': 'أدوار المستأجر',
  'accessgov.pending_requests': 'طلبات الوصول المعلقة',
  'accessgov.sod_conflicts': 'تعارضات الفصل الوظيفي',
  'accessgov.system_template': 'قالب النظام',
  'accessgov.privileged': 'مميز',
  'accessgov.title': 'حوكمة الوصول',
  'connector.active': 'الموصلات النشطة',
  'connector.none': 'لا توجد موصلات مكونة',
  'connector.file_based': 'بناءً على الملف',
  'connector.api_sync': 'مزامنة API',
  'connector.name': 'اسم الموصل *',
  'connector.direction': 'اتجاه المزامنة',
  'connector.base_url': 'عنوان URL الأساسي',
  'connector.auto_sync': 'تمكين المزامنة التلقائية',
  'connector.auth_type': 'نوع المصادقة',
  'connector.title': 'مركز الموصلات',
  'metamodel.name': 'اسم النموذج الوصفي *',
  'metamodel.domains': 'المجالات',
  'metamodel.domains_desc': 'نظم النموذج الوصفي حسب المجالات المعمارية',
  'metamodel.object_types': 'أنواع الكائنات',
  'metamodel.object_types_desc': 'أنواع كيانات هندسة المؤسسات المحددة في النموذج الوصفي',
  'metamodel.title': 'النموذج الوصفي',
  'eaviews.library': 'مكتبة المشاهد',
  'eaviews.my_views': 'مشاهدي',
  'eaviews.rel_changes': 'تغييرات العلاقات',
  'eaviews.title': 'مشاهد هندسة المؤسسات',
  'copilot.new_meeting': 'اجتماع جديد',
  'copilot.meeting_title': 'عنوان الاجتماع *',
  'copilot.meeting_date': 'تاريخ الاجتماع',
  'copilot.meeting_desc': 'حمّل نصوص الاجتماع واحصل على مهندس معماري خاص بالمجال',
  'copilot.no_meetings': 'لا توجد اجتماعات بعد',
  'copilot.new_conversation': '+ محادثة جديدة',
  'copilot.no_conversations': 'لا توجد محادثات بعد',
  'copilot.multi_architect': 'استشارة متعددة المهندسين',
  'copilot.cache_hint': 'تم تخزين السياق لمدة 5 دقائق',
  'adm.use': '+ استخدام',
  'adm.ai_ready': 'المحتوى الذكي جاهز',
  'adm.steps': 'الخطوات',
  'adm.no_inputs': 'لا توجد مدخلات لهذه الخطوة',
  'adm.no_outputs': 'لا توجد مخرجات لهذه الخطوة',
  'adm.export': 'تصدير حزمة دورة ADM',
  'settings.appearance_desc': 'تخصيص مظهر المنصة لمؤسستك',
  'settings.logo': 'الشعار',
  'settings.no_logo': 'لم يتم رفع شعار',
  'settings.favicon': 'أيقونة الموقع',
  'settings.no_favicon': 'لم يتم رفع أيقونة',
  'settings.export_desc': 'تكوين السلوك الافتراضي لتصدير Word و PowerPoint',
  'settings.export_lang': 'لغة التصدير الافتراضية',
  'settings.template_style': 'نمط القالب',
  'settings.style_professional': 'احترافي',
  'settings.style_government': 'حكومي',
  'settings.style_minimal': 'بسيط',
  'settings.footer_text': 'نص التذييل',
  'settings.gov_desc': 'تكوين سير عمل حوكمة المعمارية وعتبات الموافقة',
  'settings.gov_mode': 'وضع الحوكمة',
  'governance.no_findings': 'لا توجد نتائج تطابق مرشح الخطورة النشط',
  'governance.title': 'مراجعات الحوكمة',
  'severity.critical': 'حرج',
  'severity.high': 'عالي',
  'severity.medium': 'متوسط',
  'severity.low': 'منخفض',
  'strategy.current_alignments': 'المحاذاة الحالية',
  'strategy.overall_score': 'الدرجة الإجمالية',
  'strategy.strong_goals': 'أهداف قوية',
  'strategy.goals_with_gaps': 'أهداف بفجوات',
  'review.hld': 'مراجعة HLD',
  'review.lld': 'مراجعة LLD',
  'domain.app_integration': 'تكامل التطبيقات',
  'domain.data': 'معمارية البيانات',
  'domain.infrastructure': 'البنية التحتية',
  'domain.security': 'معمارية الأمن',
  'domain.business': 'معمارية الأعمال',
  'domain.beneficiary': 'تجربة المستفيد',
  'dashboard.monthly_reviews': 'المراجعات الشهرية والدرجة المتوسطة',

  'common.more_info': 'مزيد من المعلومات',
  'diagramviewer.diagrams': 'مخططات ({count})',
  'diagramviewer.view': '▼ عرض',
  'diagramviewer.hide': '▲ إخفاء',
  'diagramviewer.source': '< المصدر',
  'diagramviewer.visual': '👁 مرئي',
  'diagramviewer.download_svg': '↓ SVG',
  'diagramviewer.download_source': '↓ المصدر',
  'phase7.phase_step': 'المرحلة {phase}{step}',
  'phase7.domains': 'المجالات: {domains}',
  'phase7.ref': 'المرجع: {ref}',
  'phase7.rationale': 'التبرير:',
  'phase7.notes': 'ملاحظات:',
  'innovation.change_reason': '{reason}',
