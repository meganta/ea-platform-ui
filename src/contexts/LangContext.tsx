...
const TRANSLATIONS: Record<string, { EN: string; AR: string }> = {
  ...
  'copilot.prov.question_type': { EN: 'Question type', AR: 'نوع السؤال' },
  'copilot.prov.time': { EN: 'Time reference', AR: 'المرجع الزمني' },
  'copilot.prov.modules': { EN: 'Modules consulted', AR: 'الوحدات التي تم الرجوع إليها' },
  'copilot.prov.conflicts': { EN: 'Conflicts disclosed', AR: 'تعارضات تم الإفصاح عنها' },
  'copilot.prov.not_recorded': { EN: 'Items not recorded', AR: 'عناصر غير مسجّلة' },
  'copilot.prov.basis': { EN: 'Answer basis', AR: 'أساس الإجابة' },
  'copilot.prov.basis.HIGH': { EN: 'Strong', AR: 'قوي' },
  'copilot.prov.basis.MEDIUM': { EN: 'Partial', AR: 'جزئي' },
  'copilot.prov.basis.LOW': { EN: 'Limited', AR: 'محدود' },
  'copilot.prov.kind.recorded': { EN: 'Recorded', AR: 'مسجّل' },
  'copilot.prov.kind.derived': { EN: 'Derived', AR: 'مستنتج من الروابط' },
  'copilot.prov.kind.document': { EN: 'Document', AR: 'وثيقة' },
  'copilot.prov.step.OK': { EN: 'checked', AR: 'تم التحقق' },
  'copilot.prov.step.DENIED': { EN: 'no access', AR: 'لا توجد صلاحية' },
  'copilot.prov.step.SKIPPED': { EN: 'link not recorded', AR: 'الرابط غير مسجّل' },
  'copilot.prov.step.FAILED': { EN: 'unavailable', AR: 'غير متاح' },
  'copilot.prov.module.ADM': { EN: 'ADM', AR: 'دورات ADM' },
  'copilot.prov.module.REPOSITORY': { EN: 'EA Repository', AR: 'مستودع البنية المؤسسية' },
  'copilot.prov.module.SCENARIO': { EN: 'Architecture Scenarios', AR: 'السيناريوهات المعمارية' },
  'copilot.prov.module.GOVERNANCE': { EN: 'Governance Reviews', AR: 'مراجعات الحوكمة' },
  'copilot.prov.module.PLANNING': { EN: 'EA Planning', AR: 'تخطيط البنية المؤسسية' },
  'copilot.prov.module.DECISIONS': { EN: 'Architecture Decisions', AR: 'القرارات المعمارية' },
  'copilot.prov.module.VIEWS': { EN: 'EA Views', AR: 'مخططات البنية المؤسسية' },
  'copilot.prov.module.KNOWLEDGE': { EN: 'Knowledge Base', AR: 'قاعدة المعرفة' },
  'copilot.prov.module.META_MODEL': { EN: 'Meta-Model', AR: 'النموذج الفوقي' },
  'copilot.prov.temporal.LATEST': { EN: 'Latest', AR: 'الأحدث' },
  'copilot.prov.temporal.CURRENT': { EN: 'Current', AR: 'الحالي' },
  'copilot.prov.temporal.PREVIOUS': { EN: 'Previous', AR: 'السابق' },
  'copilot.prov.temporal.COMPLETED': { EN: 'Most recently completed', AR: 'آخر ما اكتمل' },
  'copilot.prov.intent.ADM_CYCLE_LIST': { EN: 'ADM cycles', AR: 'دورات ADM' },
  'copilot.prov.intent.ADM_CYCLE_STATUS': { EN: 'ADM cycle status', AR: 'حالة دورة ADM' },
  'copilot.prov.intent.ADM_PENDING_ACTIONS': { EN: 'Pending ADM work', AR: 'الأعمال المعلّقة في دورة ADM' },
  'copilot.prov.intent.ADM_OUTPUTS': { EN: 'ADM outputs', AR: 'مخرجات دورة ADM' },
  'copilot.prov.intent.SCENARIO_LIST': { EN: 'Architecture scenarios', AR: 'السيناريوهات المعمارية' },
  'copilot.prov.intent.SCENARIO_CONTENTS': { EN: 'Contents of an architecture scenario', AR: 'محتوى السيناريو المعماري' },
  'copilot.prov.intent.SCENARIO_COMPARE': { EN: 'Comparison of architecture states', AR: 'مقارنة الحالات المعمارية' },
  'copilot.prov.intent.VIEW_LIST': { EN: 'EA Views', AR: 'مخططات البنية المؤسسية' },
  'copilot.prov.intent.GOVERNANCE_REVIEWS': { EN: 'Governance reviews', AR: 'مراجعات الحوكمة' },
  'copilot.prov.intent.GOVERNANCE_FINDINGS': { EN: 'Governance findings', AR: 'ملاحظات الحوكمة' },
  'copilot.prov.intent.GOVERNANCE_DECISIONS': { EN: 'Governance decisions and conditions', AR: 'قرارات الحوكمة وشروطها' },
  'copilot.prov.intent.PLANNING_PLANS': { EN: 'EA plans', AR: 'خطط البنية المؤسسية' },
  'copilot.prov.intent.PLANNING_ITEMS_DUE': { EN: 'Plan items due', AR: 'بنود الخطط المستحقة' },
  'copilot.prov.intent.DECISIONS_LIST': { EN: 'Architecture decisions', AR: 'القرارات المعمارية' },
  'copilot.prov.intent.KNOWLEDGE_SEARCH': { EN: 'Knowledge Base search', AR: 'البحث في قاعدة المعرفة' },
  'copilot.prov.intent.ENTITY_OVERVIEW': { EN: 'One object across modules', AR: 'عنصر واحد عبر الوحدات' },
  'copilot.prov.intent.ADM_GOVERNANCE_IMPACT': { EN: 'ADM impact with open findings', AR: 'أثر دورة ADM مع الملاحظات المفتوحة' },
  'copilot.prov.intent.TARGET_BLOCKERS': { EN: 'What stands between Current and Target', AR: 'ما يحول بين البنية الحالية والمستهدفة' },
  'copilot.prov.intent.ENTITY_IN_SCENARIO': { EN: 'The same object in another architecture state', AR: 'العنصر نفسه في حالة معمارية أخرى' },
  'copilot.prov.intent.SET_GOVERNANCE_FINDINGS': { EN: 'Governance findings for the previous results', AR: 'ملاحظات الحوكمة على النتائج السابقة' },
  ...
  'studio.export_title':         { EN: 'Export', AR: 'تصدير' },
  'studio.language_help':        { EN: 'The file is produced in the language of this output: Arabic outputs become right-to-left documents, with the first item on the right.', AR: 'يُنتَج الملف بلغة هذا المخرج: المخرجات العربية تُصدَّر من اليمين إلى اليسار، ويظهر العنصر الأول في الجهة اليمنى.' },
  'studio.format':               { EN: 'Format', AR: 'الصيغة' },
  'studio.format_pptx':          { EN: 'PowerPoint', AR: 'PowerPoint' },
  'studio.format_docx':          { EN: 'Word', AR: 'Word' },
  'studio.detail':               { EN: 'Detail', AR: 'مستوى التفصيل' },
  'studio.detail_executive':     { EN: 'Executive', AR: 'تنفيذي' },
  'studio.detail_standard':      { EN: 'Standard', AR: 'قياسي' },
  'studio.detail_detailed':      { EN: 'Detailed', AR: 'تفصيلي' },
  'studio.include_views':        { EN: 'Include architecture views linked to this output', AR: 'تضمين المشاهد المعمارية المرتبطة بهذا المخرج' },
  'studio.include_evidence':     { EN: 'Add input evidence appendix', AR: 'إضافة ملحق بالمدخلات والأدلة' },
  'studio.generate_pptx':        { EN: 'Generate PowerPoint', AR: 'إنشاء عرض PowerPoint' },
  ...
  'nav.ea_planning':   { EN: 'EA Planning', AR: 'تخطيط البنية المؤسسية' },
  'nav.strategy':      { EN: 'Strategy', AR: 'الاستراتيجية' },
  'nav.decision_evaluation': { EN: 'Decision & Evaluation', AR: 'القرار والتقييم' },
  'nav.meta_model':    { EN: 'Meta-Model', AR: 'النموذج الفوقي' },
  'nav.ea_views':      { EN: 'EA Views', AR: 'مخططات البنية المؤسسية' },
  ...
  'gov.open_findings':         { EN: 'Open Findings', AR: 'الملاحظات المفتوحة' },
  'gov.none_critical':         { EN: 'none critical', AR: 'لا توجد ملاحظات حرجة' },
  'gov.last_6_months':         { EN: 'last 6 months', AR: 'آخر 6 أشهر' },
  'gov.dashboard_help':        { EN: 'Avg Score is the average overall score across your completed reviews only (a review still awaiting manual approval does not count yet). Open Findings are issues not yet resolved across all reviews. Score Trend shows completed reviews and their average score by month.', AR: 'متوسط النتيجة هو متوسط النتيجة الإجمالية للمراجعات المكتملة فقط (لا تُحتسب المراجعة التي لا تزال بانتظار الموافقة اليدوية). الملاحظات المفتوحة هي المشكلات التي لم تُحل بعد عبر جميع المراجعات. يعرض اتجاه النتائج المراجعات المكتملة ومتوسط نتيجتها شهريًا.' },
  // Report sections
  ...
  'common.definition': { EN: 'Definition', AR: 'التعريف' },
  'common.all_domains': { EN: 'All Domains', AR: 'جميع المجالات' },
  'common.active': { EN: 'Active', AR: 'نشط' },
  'common.frequency': { EN: 'Frequency', AR: 'التكرار' },
  'common.objectives': { EN: 'Objectives', AR: 'الأهداف' },
  'common.scope': { EN: 'Scope', AR: 'النطاق' },
  'common.permissions': { EN: 'Permissions', AR: 'الصلاحيات' },
  'common.users': { EN: 'Users', AR: 'المستخدمون' },
  'common.system': { EN: 'System', AR: 'نظام' },
  'common.custom': { EN: 'Custom', AR: 'مخصص' },
  'common.coming_soon': { EN: 'Coming Soon', AR: 'قريباً' },
  'common.minutes': { EN: 'minutes', AR: 'دقائق' },
  'common.and': { EN: 'and', AR: 'و' },
  'common.icon': { EN: 'Icon', AR: 'الأيقونة' },
  'common.color': { EN: 'Color', AR: 'اللون' },
  'common.code': { EN: 'Code', AR: 'الرمز' },
  'common.name_ar': { EN: 'Arabic Name', AR: 'الاسم بالعربية' },
  'common.all_stakeholders': { EN: 'All Stakeholders', AR: 'جميع أصحاب المصلحة' },
  'common.all_categories': { EN: 'All Categories', AR: 'جميع الفئات' },
  'common.all_status': { EN: 'All Status', AR: 'جميع الحالات' },
  'common.published': { EN: 'Published', AR: 'منشور' },
  'common.all_states': { EN: 'All Architecture States', AR: 'جميع حالات المعمارية' },
  'common.promise': { EN: 'Promise', AR: 'وعد' },
  'common.left': { EN: 'Left', AR: 'يسار' },
  'common.right': { EN: 'Right', AR: 'يمين' },
  'common.added': { EN: 'Added', AR: 'مضاف' },
  'common.modified': { EN: 'Modified', AR: 'معدل' },
  'common.unchanged': { EN: 'Unchanged', AR: 'دون تغيير' },
  'common.auto_detect': { EN: 'Auto detect', AR: 'اكتشاف تلقائي' },
  'common.total': { EN: 'Total', AR: 'الإجمالي' },
  'common.asset_type': { EN: 'Asset Type', AR: 'نوع الأصل' },
  'common.owner': { EN: 'Owner', AR: 'المالك' },
  'common.meta_attrs': { EN: 'META MODEL ATTRIBUTES', AR: 'سمات النموذج الوصفي' },
  'common.no_attachments': { EN: 'No attachments yet', AR: 'لا توجد مرفقات بعد' },
  'common.severity': { EN: 'Severity', AR: 'الخطورة' },
  'common.recommendation': { EN: 'Recommendation', AR: 'التوصية' },
  'common.solution': { EN: 'SOLUTION', AR: 'الحل' },
  'common.business_owner': { EN: 'BUSINESS OWNER', AR: 'مالك العمل' },
  'common.tech_owner': { EN: 'TECH OWNER', AR: 'مالك التقنية' },
  'common.tech_detected': { EN: 'TECHNOLOGIES DETECTED', AR: 'التقنيات المكتشفة' },
  'common.open': { EN: 'Open', AR: 'مفتوح' },
  'common.accepted': { EN: 'Accepted', AR: 'مقبول' },
  'common.confirmed': { EN: 'Confirmed', AR: 'مؤكد' },
  'common.all_review_types': { EN: 'All Review Types', AR: 'جميع أنواع المراجعة' },
  'common.quick_actions': { EN: 'QUICK ACTIONS', AR: 'إجراءات سريعة' },
  'app.title': { EN: 'EA Platform', AR: 'منصة هندسة المؤسسات' },
  'framework.nora': { EN: 'NORA', AR: 'نورا' },
  'shared.link_unavailable': { EN: 'Link unavailable', AR: 'الرابط غير متاح' },
  'shared.title': { EN: 'Shared View', AR: 'عرض مشترك' },
  'glossary.subtitle': { EN: 'Bilingual EA terminology definitions for this tenant', AR: 'تعريفات المصطلحات ثنائية اللغة لهندسة المؤسسات' },
  'glossary.new_term': { EN: '+ New Term', AR: '+ مصطلح جديد' },
  'glossary.title': { EN: 'EA Glossary', AR: 'مسرد المصطلحات' },
  'eaplanning.subtitle': { EN: 'Strategic and operational plans for the EA practice', AR: 'خطط استراتيجية وتشغيلية لممارسة هندسة المؤسسات' },
  'eaplanning.total_plans': { EN: 'Total Plans', AR: 'إجمالي الخطط' },
  'eaplanning.avg_progress': { EN: 'Avg Progress', AR: 'متوسط التقدم' },
  'eaplanning.high_risk': { EN: 'High-Risk Plans', AR: 'خطط عالية المخاطر' },
  'eaplanning.by_type': { EN: 'By Plan Type', AR: 'حسب النوع' },
  'eaplanning.new_plan': { EN: 'New EA Plan', AR: 'خطة هندسة معمارية جديدة' },
  'eaplanning.plan_type': { EN: 'Plan Type *', AR: 'نوع الخطة *' },
  'eaplanning.period_label': { EN: 'Period Label', AR: 'تسمية الفترة' },
  'eaplanning.domains_scope': { EN: 'EA Domains in Scope', AR: 'مجالات هندسة المؤسسات في النطاق' },
  'eaplanning.title': { EN: 'EA Planning', AR: 'تخطيط هندسة المؤسسات' },
  'accessgov.tenant_roles': { EN: 'Tenant Roles', AR: 'أدوار المستأجر' },
  'accessgov.pending_requests': { EN: 'Pending Access Requests', AR: 'طلبات الوصول المعلقة' },
  'accessgov.sod_conflicts': { EN: 'SoD Conflicts', AR: 'تعارضات الفصل الوظيفي' },
  'accessgov.system_template': { EN: 'System Template', AR: 'قالب النظام' },
  'accessgov.privileged': { EN: 'Privileged', AR: 'مميز' },
  'accessgov.title': { EN: 'Access Governance', AR: 'حوكمة الوصول' },
  'connector.active': { EN: 'Active Connectors', AR: 'الموصلات النشطة' },
  'connector.none': { EN: 'No connectors configured', AR: 'لا توجد موصلات مكونة' },
  'connector.file_based': { EN: 'File-based', AR: 'بناءً على الملف' },
  'connector.api_sync': { EN: 'API Sync', AR: 'مزامنة API' },
  'connector.name': { EN: 'Connector Name *', AR: 'اسم الموصل *' },
  'connector.direction': { EN: 'Sync Direction', AR: 'اتجاه المزامنة' },
  'connector.base_url': { EN: 'API Base URL', AR: 'عنوان URL الأساسي' },
  'connector.auto_sync': { EN: 'Enable automatic sync', AR: 'تمكين المزامنة التلقائية' },
  'connector.auth_type': { EN: 'Auth Type', AR: 'نوع المصادقة' },
  'connector.title': { EN: 'Connector Hub', AR: 'مركز الموصلات' },
  'metamodel.name': { EN: 'Meta-Model Name *', AR: 'اسم النموذج الوصفي *' },
  'metamodel.domains': { EN: 'Domains', AR: 'المجالات' },
  'metamodel.domains_desc': { EN: 'Organize your meta-model by architectural domains', AR: 'نظم النموذج الوصفي حسب المجالات المعمارية' },
  'metamodel.object_types': { EN: 'Object Types', AR: 'أنواع الكائنات' },
  'metamodel.object_types_desc': { EN: 'EA entity types defined in your meta-model', AR: 'أنواع كيانات هندسة المؤسسات المحددة في النموذج الوصفي' },
  'metamodel.title': { EN: 'Meta-Model', AR: 'النموذج الوصفي' },
  'eaviews.library': { EN: 'View Library', AR: 'مكتبة المشاهد' },
  ...
  'copilot.meeting_desc': { EN: 'Upload meeting transcripts and get domain-specific architect', AR: 'حمّل نصوص الاجتماع واحصل على مهندس معماري خاص بالمجال' },
  'copilot.no_meetings': { EN: 'No meetings yet', AR: 'لا توجد اجتماعات بعد' },
  'copilot.new_conversation': { EN: '+ New Conversation', AR: '+ محادثة جديدة' },
  'copilot.no_conversations': { EN: 'No conversations yet', AR: 'لا توجد محادثات بعد' },
  'copilot.multi_architect': { EN: 'Multi-Architect Consultation', AR: 'استشارة متعددة المهندسين' },
  'copilot.cache_hint': { EN: 'Context cached 5 min', AR: 'تم تخزين السياق لمدة 5 دقائق' },
  'adm.use': { EN: '+ Use', AR: '+ استخدام' },
  'adm.ai_ready': { EN: 'AI CONTENT READY', AR: 'المحتوى الذكي جاهز' },
  'adm.steps': { EN: 'STEPS', AR: 'الخطوات' },
  'adm.no_inputs': { EN: 'No inputs for this step', AR: 'لا توجد مدخلات لهذه الخطوة' },
  'adm.no_outputs': { EN: 'No outputs for this step', AR: 'لا توجد مخرجات لهذه الخطوة' },
  'adm.export': { EN: 'Export ADM Cycle Package', AR: 'تصدير حزمة دورة ADM' },
  'settings.appearance_desc': { EN: 'Customize the platform appearance for your organization', AR: 'تخصيص مظهر المنصة لمؤسستك' },
  'settings.logo': { EN: 'Logo', AR: 'الشعار' },
  'settings.no_logo': { EN: 'No logo uploaded', AR: 'لم يتم رفع شعار' },
  'settings.favicon': { EN: 'Favicon', AR: 'أيقونة الموقع' },
  'settings.no_favicon': { EN: 'No favicon uploaded', AR: 'لم يتم رفع أيقونة' },
  'settings.export_desc': { EN: 'Configure default behavior for Word and PowerPoint exports', AR: 'تكوين السلوك الافتراضي لتصدير Word و PowerPoint' },
  'settings.export_lang': { EN: 'Default Export Language', AR: 'لغة التصدير الافتراضية' },
  'settings.template_style': { EN: 'Template Style', AR: 'نمط القالب' },
  'settings.style_professional': { EN: 'Professional', AR: 'احترافي' },
  'settings.style_government': { EN: 'Government', AR: 'حكومي' },
  'settings.style_minimal': { EN: 'Minimal', AR: 'بسيط' },
  'settings.footer_text': { EN: 'Footer Text', AR: 'نص التذييل' },
  'settings.gov_desc': { EN: 'Configure architecture governance workflows and approval thresholds', AR: 'تكوين سير عمل حوكمة المعمارية وعتبات الموافقة' },
  'settings.gov_mode': { EN: 'Governance Mode', AR: 'وضع الحوكمة' },
  'governance.no_findings': { EN: 'No findings match the active severity filter', AR: 'لا توجد نتائج تطابق مرشح الخطورة النشط' },
  'governance.title': { EN: 'Governance Reviews', AR: 'مراجعات الحوكمة' },
  ...
  'strategy.current_alignments': { EN: 'Current Alignments', AR: 'المحاذاة الحالية' },
  'strategy.goals_with_gaps': { EN: 'Goals with Gaps', AR: 'أهداف بفجوات' },
  'review.hld': { EN: 'HLD Review', AR: 'مراجعة HLD' },
  'review.lld': { EN: 'LLD Review', AR: 'مراجعة LLD' },
  'domain.app_integration': { EN: 'Application Integration', AR: 'تكامل التطبيقات' },
  'domain.data': { EN: 'Data Architecture', AR: 'معمارية البيانات' },
  'domain.infrastructure': { EN: 'Infrastructure', AR: 'البنية التحتية' },
  'domain.security': { EN: 'Security Architecture', AR: 'معمارية الأمن' },
  'domain.business': { EN: 'Business Architecture', AR: 'معمارية الأعمال' },
  'domain.beneficiary': { EN: 'Beneficiary Experience', AR: 'تجربة المستفيد' },
  'dashboard.monthly_reviews': { EN: 'Monthly Reviews & Avg Score', AR: 'المراجعات الشهرية والدرجة المتوسطة' },
  'common.more_info': { EN: 'More information', AR: 'مزيد من المعلومات' },
  'diagramviewer.diagrams': { EN: 'Diagrams ({count})', AR: 'مخططات ({count})' },
  'diagramviewer.view': { EN: '▼ View', AR: '▼ عرض' },
  'diagramviewer.hide': { EN: '▲ Hide', AR: '▲ إخفاء' },
  'diagramviewer.source': { EN: '< Source', AR: '< المصدر' },
  'diagramviewer.visual': { EN: '👁 Visual', AR: '👁 مرئي' },
  'diagramviewer.download_svg': { EN: '↓ SVG', AR: '↓ SVG' },
  'diagramviewer.download_source': { EN: '↓ Source', AR: '↓ المصدر' },
  'phase7.phase_step': { EN: 'Phase {phase}{step}', AR: 'المرحلة {phase}{step}' },
  'phase7.domains': { EN: 'Domains: {domains}', AR: 'المجالات: {domains}' },
  'phase7.ref': { EN: 'Ref: {ref}', AR: 'المرجع: {ref}' },
  'phase7.rationale': { EN: 'Rationale:', AR: 'التبرير:' },
  'phase7.notes': { EN: 'Notes:', AR: 'ملاحظات:' },
  'innovation.change_reason': { EN: '{reason}', AR: '{reason}' },
  'users.title': { EN: 'Users', AR: 'المستخدمون' },
  'users.tab_users': { EN: 'Active Users', AR: 'المستخدمون النشطون' },
  'users.tab_invitations': { EN: 'Pending Invitations', AR: 'الدعوات المعلقة' },
  'users.invite': { EN: 'Invite by Email', AR: 'دعوة بالبريد' },
  'users.create': { EN: 'Create User', AR: 'إنشاء مستخدم' },
  'users.name': { EN: 'Name', AR: 'الاسم' },
  'users.email': { EN: 'Email', AR: 'البريد' },
  ...
  'users.pending': { EN: 'Pending', AR: 'معلق' },
  'users.edit': { EN: 'Edit', AR: 'تعديل' },
  'users.reset_pw': { EN: 'Reset PW', AR: 'إعادة تعيين' },
  'users.deactivate': { EN: 'Deactivate', AR: 'إلغاء التفعيل' },
  'users.cancel': { EN: 'Cancel', AR: 'إلغاء' },
  'users.copy_link': { EN: 'Copy Link', AR: 'نسخ الرابط' },
  'users.no_users': { EN: 'No users yet.', AR: 'لا يوجد مستخدمون.' },
  'users.no_invitations': { EN: 'No pending invitations.', AR: 'لا توجد دعوات معلقة.' },
  'users.invite_title': { EN: 'Invite User', AR: 'دعوة مستخدم' },
  'users.create_title': { EN: 'Create User', AR: 'إنشاء مستخدم' },
  'users.edit_title': { EN: 'Edit User', AR: 'تعديل مستخدم' },
  'users.reset_title': { EN: 'Reset Password', AR: 'إعادة تعيين كلمة المرور' },
  'users.full_name': { EN: 'Full Name', AR: 'الاسم الكامل' },
  'users.password': { EN: 'Password', AR: 'كلمة المرور' },
  'users.new_password': { EN: 'New Password', AR: 'كلمة المرور الجديدة' },
  'users.role_architect': { EN: 'Architect', AR: 'مهندس معماري' },
  'users.role_reviewer': { EN: 'Reviewer', AR: 'مراجع' },
  'users.role_admin': { EN: 'Tenant Admin', AR: 'مسؤول المستأجر' },
  'users.send_invite': { EN: 'Send Invitation', AR: 'إرسال الدعوة' },
  'users.save': { EN: 'Save', AR: 'حفظ' },
  'users.reset': { EN: 'Reset', AR: 'إعادة تعيين' },
  'users.reset_for': { EN: 'Reset password for', AR: 'إعادة تعيين كلمة المرور لـ' },
