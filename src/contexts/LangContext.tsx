 ...
 * 
  ...
  'users.tab_users': 'المستخدمون النشطون',
  'users.tab_invitations': 'الدعوات المعلقة',
  'users.invite': 'دعوة بالبريد',
  ...
  'users.pending': 'معلق',
  'users.edit': 'تعديل',
  'users.reset_pw': 'إعادة تعيين',
  'users.deactivate': 'إلغاء التفعيل',
  'users.cancel': 'إلغاء',
  'users.copy_link': 'نسخ الرابط',
  'users.no_users': 'لا يوجد مستخدمون.',
  'users.no_invitations': 'لا توجد دعوات معلقة.',
  'users.invite_title': 'دعوة مستخدم',
  'users.create_title': 'إنشاء مستخدم',
  'users.edit_title': 'تعديل مستخدم',
  'users.reset_title': 'إعادة تعيين كلمة المرور',
  'users.full_name': 'الاسم الكامل',
  'users.password': 'كلمة المرور',
  'users.new_password': 'كلمة المرور الجديدة',
  'users.role_architect': 'مهندس معماري',
  'users.role_reviewer': 'مراجع',
  'users.role_admin': 'مسؤول المستأجر',
  'users.send_invite': 'إرسال الدعوة',
  'users.save': 'حفظ',
  'users.reset': 'إعادة تعيين',
  'users.reset_for': 'إعادة تعيين كلمة المرور لـ',
  'users.confirm_deactivate': 'إلغاء تفعيل هذا المستخدم؟',
  'users.confirm_cancel_invite': 'إلغاء هذه الدعوة؟',
  'users.help': 'إدارة المستخدمين في المستأجر. قم بدعوة مستخدمين جدد عبر البريد الإلكتروني أو إنشاؤهم مباشرة. قم بإلغاء تفعيل المستخدمين الذين لم يعودوا بحاجة للوصول.',
====
  'users.title': 'Users',
  'users.tab_users': 'Active Users',
  'users.tab_invitations': 'Pending Invitations',
  ...
  'users.edit': 'Edit',
  'users.reset_pw': 'Reset PW',
  'users.deactivate': 'Deactivate',
  'users.cancel': 'Cancel',
  'users.copy_link': 'Copy Link',
  'users.no_users': 'No users yet.',
  'users.no_invitations': 'No pending invitations.',
  'users.invite_title': 'Invite User',
  'users.create_title': 'Create User',
  'users.edit_title': 'Edit User',
  'users.reset_title': 'Reset Password',
  'users.full_name': 'Full Name',
  'users.password': 'Password',
  'users.new_password': 'New Password',
  'users.role_architect': 'Architect',
  'users.role_reviewer': 'Reviewer',
  'users.role_admin': 'Tenant Admin',
  'users.send_invite': 'Send Invitation',
  'users.save': 'Save',
  'users.reset': 'Reset',
  'users.reset_for': 'Reset password for',
  'users.confirm_deactivate': 'Deactivate this user?',
  'users.confirm_cancel_invite': 'Cancel this invitation?',
  'users.help': 'Manage users in your tenant. Invite new users by email, or create them directly. Deactivate users who no longer need access.',
=================
