...
export default function Layout() {
  ...
  const navItems: NavItem[] = [
    ...
    { to: '/governance', label: '🏛 ' + t('nav.governance'), icon: '', permission: 'Reviews.View' },
    ...
    { to: '/strategy', label: '🎯 ' + t('nav.strategy'), icon: '', permission: 'Repository.View', superadminOnly: true },
    { to: '/ea-planning', label: '🗓 ' + t('nav.ea_planning'), icon: '', permission: 'Repository.View' },
    ...
    { to: '/meta-model', label: '🧩 ' + t('nav.meta_model'), icon: '', permission: 'MetaModel.View' },
    { to: '/ea-views', label: '🗺 ' + t('nav.ea_views'), icon: '', permission: 'Views.View' },
    { to: '/connector-hub', label: '🔌 ' + t('nav.connector_hub'), icon: '', permission: 'Repository.View', superadminOnly: true },
    ...
    { to: '/glossary', label: '📖 ' + t('nav.glossary'), icon: '', permission: 'Repository.View', superadminOnly: true },
    { to: '/users', label: '👥 ' + t('nav.users'), icon: '', permission: 'Users.View' },
    { to: '/access-governance', label: '🔐 ' + t('nav.access_governance'), icon: '', permission: 'Roles.View', superadminOnly: true },
    { to: '/settings', label: '⚙ ' + t('nav.settings'), icon: '', permission: 'Users.View', superadminOnly: true },
    { to: '/setup', label: '🏛 ' + t('nav.setup'), icon: '', permission: null, superadminOnly: true },
    { to: '/demo-requests', label: '📨 ' + t('nav.demo_requests'), icon: '', permission: null, superadminOnly: true },
  ]
